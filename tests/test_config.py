...
def test_group_size_overrides(config_event_defaults, tmp_path) -> None:
    """test group size overides"""
    ...
    config = cfg.cp.read_config_file(cfg.config)
    assert config.has_option("SESSION_GS_OVERRIDES", "1") is True
